...
Item { // Window
    ...
    property bool compactMode: Appearance.font.size.smaller * 4 > targetWindowHeight || Appearance.font.size.smaller * 4 > targetWindowWidth
    ...
    ScreencopyView {
        id: windowPreview
        anchors.fill: parent
        captureSource: SessionState.overviewOpen ? root.toplevel : null
        live: true
        ...
        ColumnLayout {
            ...
            spacing: Appearance.font.size.smaller * 0.5
